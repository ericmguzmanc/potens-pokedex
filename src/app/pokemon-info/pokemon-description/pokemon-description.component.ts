import { Component, OnInit, Input, OnChanges, transition, animate, style, trigger, state } from '@angular/core';
...
@Component({
  ...
  animations: [
    trigger('cardState', [
      state('Alpha Sapphire', style({ backgroundColor: '#007bff', color: '#eceff1' })),
      state('Omega Ruby', style({ backgroundColor: '#b71c1c', color: '#eceff1' })),
      state('Y', style({ backgroundColor: '#1e88e5', color: '#eceff1' })),
      state('X', style({ backgroundColor: '#b71c1c', color: '#eceff1' })),
      ...
      state('Ruby', style({ backgroundColor: '#b71c1c', color:'#e3f2fd' })),
